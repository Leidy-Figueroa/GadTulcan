...
<div class="panel panel-primary">
    <div class="panel-heading">En que incidencia desea utilizar el producto</div>
       <div class="panel-body">
        @if (session('notification'))
            <div class="alert alert-success">
                {{ session('notification') }}
...
<form method="POST" action=" {{ route('producto.update', $producto->id) }} " enctype="multipart/form-data" novalidate>
    ...
    <img src="{{ asset('/storage/'.$producto->imagen) }}" class="img-thumbnail" width = "100" height = "100">
        ...
        <div class="row mb-3">
            <label for="user_id" class="col-md-4 col-form-label text-md-end">Responsable</label>
            <div class="col-md-6">
             <select name="user_id" class="form-control" id="exampleFormControlInput1" placeholder="Elegir categoria" value="{{ old('incidencia') }}" >
         ...
         <div class="row mb-3">
            <label for="incidencia" class="col-md-4 col-form-label text-md-end">Nro de incidencia</label>
            <div class="col-md-6">
             <select name="incidencia" class="form-control" id="exampleFormControlInput1" placeholder="Elegir categoria" value="{{ old('incidencia') }}" >
                <option value="">Elegir incidencia para añadir al producto</option>
                @foreach($incidents as $incident)
